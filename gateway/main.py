...
while True:
    ...
    while len(my_data.change_in_device) != 0:
        if my_data.change_in_device[0] == "LED":
            my_server.publish_data(my_data.change_in_device[0], my_data.led)
        elif my_data.change_in_device[0] == "FAN":
            my_server.publish_data(my_data.change_in_device[0], my_data.fan)
        elif my_data.change_in_device[0] == "PUMP":
            my_server.publish_data(my_data.change_in_device[0], my_data.pump)
